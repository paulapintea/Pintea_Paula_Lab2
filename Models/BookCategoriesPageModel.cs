  ...
  namespace Pintea_Paula_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Pintea_Paula_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Pintea_Paula_Lab2Context context,string[] selectedCategories, Book bookToUpdate)
        {
